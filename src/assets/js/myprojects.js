...
if (slider) {
    ...
    const images = [
        new URL("../images/myprojects-slider/slider-01.webp", import.meta.url).href,
        new URL("../images/myprojects-slider/slider-02.webp", import.meta.url).href,
        new URL("../images/myprojects-slider/slider-03.webp", import.meta.url).href,
        new URL("../images/myprojects-slider/slider-04.webp", import.meta.url).href,
        new URL("../images/myprojects-slider/slider-05.webp", import.meta.url).href,
        new URL("../images/myprojects-slider/slider-06.webp", import.meta.url).href,
        new URL("../images/myprojects-slider/slider-07.webp", import.meta.url).href,
    ];
